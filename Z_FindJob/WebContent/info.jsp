<%@page import="service.imp.ICompanyServiceImp,cn.itcast.domain.*"%>
...
<div class="main">
    ...
    <p class="short-input ue-clear newstyle">
    	<label>薪资待遇：</label><input name="salary" type="text" readonly="readonly" style="border:0;background:transparent;" value="<%=company.getSalary()%>"/>
    </p>   
    <p class="short-input ue-clear newstyle">
