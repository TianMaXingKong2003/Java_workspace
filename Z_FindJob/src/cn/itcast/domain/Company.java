...
public class Company {
	...
	public String toString() {
		return "Company [id=" + id + ", username=" + username + ", password=" + password + ", name=" + name + ", phone="
				+ phone + ", email=" + email + ", location=" + location + ", trade=" + trade + ", salary=" + salary
				+ ", tip=" + tip + ", pubtime=" + pubtime + "]";
	}
