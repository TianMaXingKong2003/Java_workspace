...
public class Person {
	...
	public Person(String username, String password, String name, String sex, String birthday, String phone,
			String email, String school,String education, String trade, String salary, String tip) {
		super();
	...
	public Person(Long id, String username, String password, String name, String sex, String birthday, String phone,
			String email, String school, String education, String trade, String salary, String tip,Date pubtime) {
		super();
		this.id = id;
		this.username = username;
		this.password = password;
	...
	public String toString() {
		return "Person [id=" + id + ", username=" + username + ", password=" + password + ", name=" + name + ", sex="
				...
				+ ", education=" + education + ",trade=" + trade + ", salary=" + salary + ", tip=" + tip + ", pubtime=" + pubtime + "]";
	}
